...
<html>
  ...
  <div id="header">
    <h1><a href="http://grails.org/Searchable+Plugin" target="_blank">Top User Rated Link : Enter Tag </a></h1>
	<br><br><br><br><br><br>
    <g:form url='[controller: "searchable", action: "index"]' id="searchableForm" name="searchableForm" method="get">
        <g:textField name="q" value="${params.q}" size="200"/> <input type="submit" value="Search" />
    </g:form>
